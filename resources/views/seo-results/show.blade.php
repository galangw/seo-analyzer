    ...
    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                @php
                                    ...
                                    $contentClass =
                                        $contentScore >= 80 ? 'success' : ($contentScore >= 50 ? 'warning' : 'danger');
                                    $contentWeight = 75;
                                @endphp
                                <div class="card border-0 h-100 bg-body">
                                    <div class="card-body text-center">
                ...
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted small">
                            ...
                            <span
                                class="{{ strlen($content->title) >= 75 && strlen($content->title) <= 95
                                    ? 'text-success'
                                    : (strlen($content->title) >= 40 && strlen($content->title) <= 120
                                        ? 'text-warning'
                                        : 'text-danger') }}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    @if (isset($seoResult->detail_score['page_title']['details']) &&
                                            is_array($seoResult->detail_score['page_title']['details']))
                                                    ...
                                                    $detailClass =
                                                        $detail['score'] >= 0.8
                                                            ...
                                                            : ($detail['score'] >= 0.5
                                                                ? 'warning'
                                                                : 'danger');
                                                    $criteriaWeight = isset($detail['weight'])
                                                        ? $detail['weight'] * 100
                                                        : ($criteriaKey == 'keyword'
                                                            ? 70
                                                            : 30);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="progress" style="height: 8px; width: 80px;">
                                                            <div class="progress-bar bg-{{ $detailClass }}"
                                                                role="progressbar"
                ...
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted small">
                            <i class="bi bi-info-circle me-1"></i>
                            <span
                                class="{{ strlen($content->meta_description) >= 146 && strlen($content->meta_description) <= 160
                                    ? 'text-success'
                                    : (strlen($content->meta_description) >= 100 && strlen($content->meta_description) < 146
                                        ? 'text-warning'
                                        : 'text-danger') }}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    @if (isset($seoResult->detail_score['meta_description']['details']) &&
                                            is_array($seoResult->detail_score['meta_description']['details']))
                                        ...
                                        @foreach ($seoResult->detail_score['content']['details'] as $key => $detail)
                                            @if (is_array($detail) && isset($detail['score']))
                                                @php
                                                    ...
                                                    $criteriaName =
                                                        $criteriaNames[$key] ?? ucfirst(str_replace('_', ' ', $key));
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <small
                                                            class="d-block text-center mt-1">{{ number_format($detail['score'] * 100, 0) }}%</small>
                                                    </td>
        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-body d-flex justify-content-between align-items-center">
                        <h6 class="mb-0 fw-bold"><i class="bi bi-lightbulb me-2"></i>Recommendations to Improve Your Score
                        </h6>
                    </div>
                    <div class="card-body">
                        @if (isset($seoResult->detail_score['recommendations']) &&
                                is_array($seoResult->detail_score['recommendations']) &&
                                count($seoResult->detail_score['recommendations']) > 0)
                            <div class="table-responsive">
                                        ...
                                        @foreach ($seoResult->detail_score['recommendations'] as $recommendation)
                                            @if (is_array($recommendation))
                                                <tr>
                                                    <td>
                                                        <span
                                                            class="badge bg-{{ $recommendation['section'] == 'Page Title'
                                                                ? 'primary text-dark'
                                                                : ($recommendation['section'] == 'Meta Description'
                                                                    ? 'info'
                                                                    : 'secondary') }}">
                                                    ...
                                                    <td>{{ $recommendation['description'] ?? 'No description available' }}
                                                    </td>
                                                    <td>
                                                        @if (!empty($recommendation['actual']))
                                                            <small
                                                                class="d-block text-muted">{{ $recommendation['actual'] }}</small>
                                                        @endif
                                                        @if (!empty($recommendation['recommended']))
                                                            <small
                                                                class="d-block text-success">{{ $recommendation['recommended'] }}</small>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endif
                        ...
                        @else
                            <div class="alert alert-success">
                                <i class="bi bi-trophy me-2"></i> Congratulations! Your content doesn't have any major SEO
                                issues.
                            </div>
                        @endif
                    </div>
